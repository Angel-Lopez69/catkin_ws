...
class disRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type disRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type disRequest
    let len;
    let data = new disRequest(null);
  ...
  static datatype() {
    ...
    return 'beginner_tutorials/disRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new disRequest(null);
    if (msg.x1 !== undefined) {
      resolved.x1 = msg.x1;
    }
    else {
...
class disResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type disResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type disResponse
    let len;
    let data = new disResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new disResponse(null);
...
module.exports = {
  ...
  datatype() { return 'beginner_tutorials/dis'; }
};
